 ...
 * @since 1.0.0
 */
function traktivity_register_post_type() {
...
add_action( 'init', 'traktivity_register_post_type', 0 );
 ...
 */
function traktivity_whitelist_post_type_wpcom( $allowed_post_types ) {
	$allowed_post_types[] = 'traktivity_event';
	return $allowed_post_types;
}
add_filter( 'rest_api_allowed_post_types', 'traktivity_whitelist_post_type_wpcom' );
 ...
 * @since 1.0.0
 */
function traktivity_register_event_type_taxonomy() {
...
add_action( 'init', 'traktivity_register_event_type_taxonomy', 0 );
 ...
 * @since 1.0.0
 */
function traktivity_register_genre_taxonomy() {
...
add_action( 'init', 'traktivity_register_genre_taxonomy', 0 );
 ...
 * @since 1.0.0
 */
function traktivity_register_event_year_taxonomy() {
...
add_action( 'init', 'traktivity_register_event_year_taxonomy', 0 );
 ...
 * @since 1.0.0
 */
function traktivity_register_show_taxonomy() {
...
add_action( 'init', 'traktivity_register_show_taxonomy', 0 );
 ...
 * @since 1.0.0
 */
function traktivity_register_season_taxonomy() {
...
add_action( 'init', 'traktivity_register_season_taxonomy', 0 );
 ...
 * @since 1.0.0
 */
function traktivity_register_episode_taxonomy() {
...
add_action( 'init', 'traktivity_register_episode_taxonomy', 0 );
